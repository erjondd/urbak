 ...
 * @property null|Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
    ...
    public static function create($params = null, $opts = null)
    {
        ...
        $flatParams = array_column(Util::flattenParams($params), 1, 0);
