 ...
 * @property StripeObject $ach_credit_transfer
 * @property StripeObject $ach_debit
 * @property StripeObject $acss_debit
 * @property StripeObject $alipay
 ...
 * @property StripeObject $au_becs_debit
 * @property StripeObject $bancontact
 * @property StripeObject $card
 * @property StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property StripeObject $code_verification
 ...
 * @property StripeObject $giropay
 * @property StripeObject $ideal
 * @property StripeObject $klarna
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|StripeObject $metadata Set of <a href="https://stripe.com/docs/api/metadata">key-value pairs</a> that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 * @property StripeObject $multibanco
 ...
 * @property StripeObject $p24
 * @property StripeObject $receiver
 * @property StripeObject $redirect
 * @property StripeObject $sepa_credit_transfer
 * @property StripeObject $sepa_debit
 * @property StripeObject $sofort
 * @property StripeObject $source_order
 ...
 * @property StripeObject $three_d_secure
...
class Source extends ApiResource
{
     ...
     *
     * @throws UnexpectedValueException if the source is not attached to a customer
    ...
    public function sourceTransactions($params = null, $opts = null)
    {
        ...
        $obj = Util::convertToStripeObject($response, $opts);
