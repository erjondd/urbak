 ...
 * @property null|string|Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|string|Customer $customer The ID of the customer who will be billed.
 ...
 * @property null|ErrorObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property Collection $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 ...
 * @property StripeObject $threshold_reason
