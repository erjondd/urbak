 ...
 * @property null|string|Account|AlipayAccount|BankAccount|BitcoinReceiver|Card|Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property Collection $sources The customer's payment sources, if any.
 * @property Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property Collection $tax_ids The customer's tax IDs.
 */
