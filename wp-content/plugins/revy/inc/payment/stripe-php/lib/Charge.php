 ...
 * @property null|string|StripeObject $application ID of the Connect application that created the charge.
 * @property null|string|ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://stripe.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 ...
 * @property null|string|BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|Account $destination ID of an existing, connected Stripe account to transfer funds to if <code>transfer_data</code> was specified in the charge request.
 * @property null|string|Dispute $dispute Details about the dispute if the charge has been disputed.
 ...
 * @property null|string|Invoice $invoice ID of the invoice this charge is for if one exists.
 ...
 * @property null|string|Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/charges-transfers">Connect documentation</a> for details.
 * @property null|string|Order $order ID of the order this charge is for if one exists.
 ...
 * @property null|string|PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 ...
 * @property Collection $refunds A list of refunds that have been applied to the charge.
 * @property null|string|Review $review ID of the review associated with this charge if one exists.
 * @property null|StripeObject $shipping Shipping information for the charge.
 * @property null|Account|AlipayAccount|BankAccount|BitcoinReceiver|Card|Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another Stripe account. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property string|Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
