 ...
 * @property string|Customer $customer ID of the customer.
 * @property null|string|CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|Invoice $invoice ID of the invoice.
 ...
 * @property null|string|Refund $refund Refund related to this credit note.
