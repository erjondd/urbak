 ...
 * @property string|Customer $customer ID of the customer who owns the subscription.
 ...
 * @property null|Discount $discount Describes the current discount applied to this subscription, if there is one. When billing, a discount applied to a subscription overrides a discount applied on a customer-wide basis.
 * @property null|int $ended_at If the subscription has ended, the date the subscription ended.
 * @property Collection $items List of subscription items, each with an attached price.
 * @property null|string|Invoice $latest_invoice The most recent invoice this subscription has generated.
 ...
 * @property null|StripeObject $pause_collection If specified, payment collection for this subscription will be paused.
