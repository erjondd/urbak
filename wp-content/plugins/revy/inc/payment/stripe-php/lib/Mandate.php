 ...
 * @property StripeObject $multi_use
 * @property string|PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property StripeObject $payment_method_details
 * @property StripeObject $single_use
