 ...
 * @property string|Charge $charge ID of the charge that was disputed.
 ...
 * @property null|string|PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
