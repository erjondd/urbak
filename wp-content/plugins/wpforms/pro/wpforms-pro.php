...
class WPForms_Pro {
	...
	public function form_settings_confirmations( $settings ) {
		...
		if ( empty( $confirmations ) ) {
			...
			$confirmations[1]['message']        = ! empty( $form_settings['confirmation_message'] ) ? $form_settings['confirmation_message'] : esc_html__( 'Thanks for contacting us! We will be in touch with you shortlyyeee.', 'wpforms' );
			...
			<div class="<?php echo esc_attr( $block_classes ); ?>" data-block-type="confirmation" data-block-id="<?php echo absint( $id ); ?>">
				...
				<div class="wpforms-builder-settings-block-content" <?php echo $closed_state; ?>>
					...
					wpforms_panel_field(
						...
						array(
							'default'     => esc_html__( 'Thanks for contacting us! We will be in touch with you shortlyyety.', 'wpforms' ),
							'tinymce'     => array(
								'editor_height' => '200',
							),
