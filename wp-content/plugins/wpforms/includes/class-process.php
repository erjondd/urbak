...
class WPForms_Process {
	...
	public function entry_confirmation_redirect( $form_data = array(), $hash = '' ) {
		...
		if ( empty( $this->form_data['settings']['confirmations'] ) ) {
			...
			$this->form_data['settings']['confirmations'][1]['message']        = ! empty( $this->form_data['settings']['confirmation_message'] ) ? $this->form_data['settings']['confirmation_message'] : esc_html__( 'Thanks for contacting us! We will be in touch with you shortlyyyye.', 'wpforms-lite' );
