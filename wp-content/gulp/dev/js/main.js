...
jQuery(document).ready(function () {
  ...
  jQuery(".fsmenu-list .color-FF6100 a").mouseenter(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "#FF6100");
    jQuery(".fsmenu-list .color-FF6100 a").css("color", "white");
  });
  jQuery(".fsmenu-list .color-FF6100 a").mouseleave(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "black");
  });
  jQuery(".fsmenu-list .color-D13F7E a").mouseenter(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "#D13F7E");
    jQuery(".fsmenu-list .color-D13F7E a").css("color", "white");
  });
  jQuery(".fsmenu-list .color-D13F7E a").mouseleave(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "black");
  });
  jQuery(".fsmenu-list .color-000000 a").mouseenter(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "#000000 ");
    jQuery(".fsmenu-list .color-000000 a").css("color", "white");
  });
  jQuery(".color-000000 a").mouseleave(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "black");
  });
  jQuery(".fsmenu-list .contact-menulink a").mouseenter(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "#000000 ");
    jQuery(".fsmenu-list .contact-menulink a").css("color", "white");
  });
  jQuery(".contact-menulink a").mouseleave(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "black");
  });
  jQuery(".fsmenu-list .acceuil-menulink a").mouseenter(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "#000000 ");
    jQuery(".fsmenu-list .acceuil-menulink a").css("color", "white");
  });
  jQuery(".fsmenu-list .acceuil-menulink a").mouseleave(function () {
    jQuery(".fsmenu-list-wrapper").css("background-color", "black");
  });
});
